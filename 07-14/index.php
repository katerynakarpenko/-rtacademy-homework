...
<main class="container">
	...
	if( !empty( $postsTotalCount > \lib\models\PostsModel::COUNT_PER_PAGE ) ) {
		...
		?>
			<a href="#" data-current-page="2" data-max-pages="<?= intval( ceil( $postsTotalCount / \lib\models\PostsModel::COUNT_PER_PAGE ) ) ?>" class="read-more button btn-main" id="downloadMore">
				Download more
			</a>
		<?php
