...
if( !function_exists( 'travelling_blog_get_cover_list_tag' ) )
{
    /**
     * Функція відображення зображення для поста у списку, з підтримкою адаптивності
     */
    function travelling_blog_get_cover_list_tag()
    {
        the_post_thumbnail(
            'small-thumbnail',
            [
...
if( !function_exists('travelling_blog_get_last_top_article') )
{
    /**
     * Функція відображення останньго ТОП запису (якщо такий є)
     */
    function travelling_blog_get_last_top_article()
    {
